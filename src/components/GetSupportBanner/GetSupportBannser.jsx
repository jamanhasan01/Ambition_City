    ...
    <section id='GetSupportBannser'>
        <Container>
          ...
          <div className="flex flex-col  bg-mainClr py-16 px-14 text-center gap-6 text-white rounded-lg">
                <h3 className='h2 !text-white'>Get Support to Our Expert team by call or Chating </h3>
                ...
                <div className='flex gap-3 justify-center xs:flex-col'>
                    ...
                    <button className='h5 bg-white px-2 py-2 text-black text boder-[1px] border-white hover:border-black rounded-md hover:bg-black hover:text-white'>Chat by Whatsapp</button>
                </div>
            </div>
          </div>
        </Container>        
