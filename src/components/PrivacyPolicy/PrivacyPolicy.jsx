...
const PrivacyPolicy = () => {
  return (
    <section id="PrivacyPolicy">
      <Container>
        <div className="flex flex-col justify-center gap-10 items-center py-[120px] w-[50%] sm:w-[70%] xs:w-[90%] xs:text-center m-auto">
         ...
         <span className="flex flex-col gap-2 p2">
         <p>
            ...
            <p>Eget quis mi enim, leo lacinia pharetra,
            ...
            <h4 className="h4">
                    Do We use cookles and other tracking technologies?
                </h4>
                <p className="p2">Pharetra morbi libero id aliquam elit massa integer tellus. Quis felis aliquam ullamcorper porttitor. Pulvinar ullamcorper sit dictumst ut eget a, elementum eu. Maecenas est morbi mattis id in ac pellentesque ac.</p>
                <h4 className="h4">How long do we keep your information?</h4>
                <p className="p2">
                ...
                <p className="p2">Pharetra morbi libero id aliquam elit massa integer tellus. Quis felis aliquam ullamcorper porttitor. Pulvinar ullamcorper sit dictumst ut eget a, elementum eu. Maecenas est morbi mattis id in ac pellentesque ac.</p>
                <h3 className="h3">What are your privacy rights?</h3>
                <p className="p2">Pharetra morbi libero id aliquam elit massa integer tellus. Quis felis aliquam ullamcorper porttitor. Pulvinar ullamcorper sit dictumst ut eget a, elementum eu. Maecenas est morbi mattis id in ac pellentesque ac.</p>
                <h3 className="h3">How can you contact us about this policy?</h3>
                <span className="flex flex-col gap-2 p2">
                    <p className="p2">Sagittis et eu at elementum, quis in. Proin praesent volutpat egestas sociis sit lorem nunc nunc sit. Eget diam curabitur mi ac. Auctor rutrum lacus malesuada massa ornare et. Vulputate consectetur ac ultrices at diam dui eget fringilla tincidunt. Arcu sit dignissim massa erat cursus vulputate gravida id. Sed quis auctor vulputate hac elementum gravida cursus dis.</p>
                    <ol className="p2 oldstyle-nums !leading-[25px]">
